package com.cloud.dataservice1;
...
public class ContactController {
    ...
    public ContactDetails getCustomerContactDetails(@PathVariable String cid) throws InterruptedException {
        ...
        /*Create a DB transaction scenerio
        * name it dblookup
        * when you look into zipkin you will find this span under data dataservice1
        * this is a fake scenerio .we delay system manually to create a fake problem.
        * with zipkin you can see the logs and change dblookup to better performance.
        * */
